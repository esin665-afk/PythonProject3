...
# ============================================================
# НОВАЯ ФИКСТУРА — ДЛЯ ТЕСТОВ ИЗ ПРИМЕРА ЗАДАНИЯ
# ============================================================

@pytest.fixture
def example_transactions_from_homework() -> List[Dict[str, Any]]:
    """Фикстура с примером транзакций из домашнего задания."""
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
